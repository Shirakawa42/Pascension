...
namespace Pascension.Game.Soi
{
    ...
    public static class SoiFrenchCards
    {
        public static readonly Dictionary<string, (string Name, string Text)> Cards = new()
        {
            ...
            ["kiln_drone"] = ("Drone Kiln", "Gagnez 2 cristaux. Inspiration : gagnez-en 4 à la place."),
            ...
            ["venator_of_the_wastes"] = ("Valkyrie des Landes", "Gagnez 4 puissance. Inspiration : un joueur ennemi perd 2 maîtrise."),
            ...
            ["giga_source_adept"] = ("Giga, Adepte de la Source", "Quand vous jouez cette carte, piochez une carte. Activez (Domination) : gagnez 3 maîtrise."),
            ...
            ["scion_of_nothingness"] = ("Héritier du Néant", "Gagnez 3 puissance. Écho : gagnez 2 de plus par carte Spectra."),
            ...
            ["wraethe_skirmisher"] = ("Éclaireur Spectral", "Gagnez 2 puissance. Écho : gagnez-en 6 à la place."),
            ...
            ["limiter_drones"] = ("Drones Limiteurs", "Inspiration : vous pouvez bannir une carte de votre main ou de votre défausse. Piochez une carte."),
            ...
            ["pall_shades"] = ("Spectres du Voile", "Écho : gagnez 3 puissance. Piochez une carte."),
            ...
            ["breaker"] = ("Iconoclaste", "Bouclier 4. Quand vous recrutez cette carte, elle va dans votre main au lieu de votre défausse. Distorsion."),
            ["brute"] = ("Brute", "Bouclier 2. Gagnez 4 puissance. Distorsion 2."),
            ["dash"] = ("Flash", "Bouclier 2. Vous pouvez placer une carte Aion de votre défausse au-dessus de votre deck. Piochez une carte."),
            ["lucky"] = ("Chance", "Bouclier 2. Gagnez 2 cristaux. Distorsion 3."),
